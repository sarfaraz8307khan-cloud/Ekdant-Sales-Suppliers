    ...
    return (
      <div className="space-y-1.5">
        ...
        <select
          ...
          id={selectId}
          className={cn(
            "w-full h-10 px-3 rounded-lg border border-border bg-surface text-sm text-foreground",
    ...
    return (
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          id={textareaId}
          className={cn(
            "w-full px-3 py-2 rounded-lg border border-border bg-surface text-sm text-foreground",
